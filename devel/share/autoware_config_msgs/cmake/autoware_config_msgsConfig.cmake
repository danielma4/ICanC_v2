...
if("TRUE" STREQUAL "TRUE")
  set(autoware_config_msgs_SOURCE_PREFIX /home/mist/reu_ws/src/autoware_ai_messages/autoware_config_msgs)
  set(autoware_config_msgs_DEVEL_PREFIX /home/mist/reu_ws/devel)
  ...
  set(autoware_config_msgs_INSTALL_PREFIX /home/mist/reu_ws/install)
...
if(NOT "/home/mist/reu_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autoware_config_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mist/reu_ws/src/autoware_ai_messages/autoware_config_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT autoware_config_msgs_NUM_DUMMY_TARGETS)
      set(autoware_config_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::autoware_config_msgs::wrapped-linker-option${autoware_config_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR autoware_config_msgs_NUM_DUMMY_TARGETS "${autoware_config_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::autoware_config_msgs::wrapped-linker-option${autoware_config_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND autoware_config_msgs_LIBRARIES "${interface_target_name}")
